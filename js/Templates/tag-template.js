class TagTemplate {
  ...
  createTag() {
    ...
    paragraphTagText.textContent = this.tagText;

    const buttonTagCloseButton = document.createElement("button");
    buttonTagCloseButton.classList.add("main-index__tag-close-button");
    buttonTagCloseButton.innerHTML = buttonTemplate;

    buttonTagCloseButton.addEventListener("click", removeTag);
